#!/usr/bin/env python3
"""
Comprehensive test suite for cs-help.py
...
SCRIPT_PATH = Path(__file__).parent / "cs-help.py"
...
def run_ck_help(args: str) -> tuple[str, int]:
    """Run cs-help.py with given arguments and return (output, exit_code)."""
...
def main():
    print("=" * 60)
    print("cs-help.py Comprehensive Test Suite")
    print("=" * 60)
    print()
    ...
    test(
        ...
        "config",
        expect_contains=["ClaudeKit Configuration", ".cs.json"],
        expect_type="comprehensive-docs"
    )

    test(
        "6.2 '.cs.json' → comprehensive docs",
        ".cs.json",
