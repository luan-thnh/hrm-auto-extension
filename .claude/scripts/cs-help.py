...
CATEGORY_GUIDES = {
    ...
    "config": {
        ...
        "workflow": [
            ("Global", "Set user prefs in `~/.claude/.cs.json`"),
            ("Local", "Override per-project in `./.claude/.cs.json`"),
...
def show_config_guide() -> None:
    ...
    print("- Global: `~/.claude/.cs.json` (user preferences)")
    print("- Local: `./.claude/.cs.json` (project overrides)")
    print()
    ...
    print("## Quick Start")
    print()
    print("**Global config** (`~/.claude/.cs.json`) - your preferences:")
    print("```json")
    print('{')
    print('  "locale": {')
    ...
    print("```")
    print()
    print("**Local override** (`./.claude/.cs.json`) - project-specific:")
    print("```json")
    print('{')
    ...
    print("```bash")
    print("# ~/.claude/.cs.json - applies everywhere")
    ...
    print("# Local (.claude/.cs.json): issuePrefix = \"JIRA-\"")
...
def show_coding_level_guide() -> None:
    ...
    print("- Global: `~/.claude/.cs.json` - personal preference")
    print("- Local: `./.claude/.cs.json` - project override")
    print()
    print("---")
    print()
    print("## How It Works")
