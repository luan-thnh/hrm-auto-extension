...
**Project Name**: ClaudeSkill Engineer
...
**Project Management**:
- `/watzup`, `/journal`, `/scout`, `/scout:ext`, `/use-mcp`, `/check-and-commit`, `/cs-help`
...
### Support & Community
- GitHub Issues: https://github.com/claudeskill/claudeskill-engineer/issues
- Discussions: https://github.com/claudeskill/claudeskill-engineer/discussions
- Repository: https://github.com/claudeskill/claudeskill-engineer
