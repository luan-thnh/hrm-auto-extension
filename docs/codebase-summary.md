...
**Repository**: [claudeskill/claudeskill-engineer](https://github.com/claudeskill/claudeskill-engineer)

## Overview

ClaudeSkill Engineer is a comprehensive boilerplate template for building professional software projects with CLI Coding Agents (Claude Code and Open Code). It provides a complete development environment with AI-powered agent orchestration, automated workflows, and intelligent project management.

## Project Structure

```
claudeskill-engineer/
...
- `/scout`, `/scout:ext`, `/watzup`, `/journal`, `/use-mcp`, `/check-and-commit`, `/cs-help`
...
### Configuration
- `/mnt/d/www/claudeskill/claudeskill-engineer/package.json` - Node.js config
- `/mnt/d/www/claudeskill/claudeskill-engineer/.releaserc.json` - Release config
- `/mnt/d/www/claudeskill/claudeskill-engineer/.commitlintrc.json` - Commit linting
- `/mnt/d/www/claudeskill/claudeskill-engineer/.gitignore` - Git exclusions
- `/mnt/d/www/claudeskill/claudeskill-engineer/.repomixignore` - Repomix exclusions

### Documentation
- `/mnt/d/www/claudeskill/claudeskill-engineer/README.md` - Main project docs
- `/mnt/d/www/claudeskill/claudeskill-engineer/CLAUDE.md` - Agent instructions
- `/mnt/d/www/claudeskill/claudeskill-engineer/CHANGELOG.md` - Version history
- `/mnt/d/www/claudeskill/claudeskill-engineer/guide/COMMANDS.md` - Command reference

### Workflows
- `/mnt/d/www/claudeskill/claudeskill-engineer/.claude/rules/primary-workflow.md`
- `/mnt/d/www/claudeskill/claudeskill-engineer/.claude/rules/development-rules.md`
- `/mnt/d/www/claudeskill/claudeskill-engineer/.claude/rules/orchestration-protocol.md`
- `/mnt/d/www/claudeskill/claudeskill-engineer/.claude/rules/documentation-management.md`

## Related Projects

- **claudeskill** - ClaudeSkill website (`../claudeskill`)
- **claudeskill-marketing** - Marketing Kit (`../claudeskill-marketing`)
- **claudeskill-cli** - CLI setup tool (`../claudeskill-cli`)
- **claudeskill-docs** - Public docs (`../claudeskill-docs`)
...
**License**: MIT
**Author**: Duy Nguyen
**Repository**: https://github.com/claudeskill/claudeskill-engineer
