#!/usr/bin/env python3
"""Integration tests for cs-help.py using real user queries and edge cases."""

import subprocess
import sys
from pathlib import Path

SCRIPT = Path(__file__).parent / "cs-help.py"


def run_ck_help(query: str) -> str:
    """Run cs-help.py with query and return output."""
...
def test_routes_to_category(query: str, expected_category: str) -> bool:
    ...
    markers = {
        ...
        "config": [".cs.json", "global", "local", "configuration"],
...
def main():
    print("=" * 60)
    print("cs-help.py Integration Tests")
    print("=" * 60)
