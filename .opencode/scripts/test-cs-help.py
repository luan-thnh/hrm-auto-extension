...
Run: python3 .opencode/scripts/test-cs-help.py
"""
...
def run_ck_help(*args):
    """Run cs-help.py with given arguments and return output."""
...
def main():
    ...
    tests.append(test_case(
        "config guide",
        ["config"],
        [".cs.json", "Configuration", "locale", "codingLevel"]
    ))
